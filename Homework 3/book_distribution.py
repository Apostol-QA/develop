...
def get_users_dict():
    with open('../Homework 3/users.json', 'r') as json_file:
        return json.load(json_file)


def get_books_list():
    with open('../Homework 3/books.csv', 'r') as csv_file:
        books_lst = []
...
def save_users_json(users_dct):
    with open('../Homework 3/result.json', 'w') as f:
...
def filter_fields_users(users_dct) -> object:
